...
Complexity determine_complexity(const std::vector<size_t> & input_sizes, const std::vector<double> & times)
{
	...
	std::transform(input_sizes.begin(), input_sizes.end(), input_sizes_double.begin(),
	...
	std::transform(input_sizes_double.begin(), input_sizes_double.end(), squared_input_sizes.begin(),
	...
	auto best_fit = std::max_element(
	    fits.begin(), fits.end(), [](const std::pair<double, Complexity> & a, const std::pair<double, Complexity> & b) {
